                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="text-center mb-4 mb-md-5">
                                                            <a href="/index" class="d-block auth-logo">
                                                                <img src="{{URL::asset('assets/images/ssss.png')}}" alt="" height="90" class="auth-logo-dark me-start">
                                                            </a>
                                                        </div>
                                                        <div class="auth-content my-auto">
                                                            <div class="text-center">
                                                                <h5 class="mb-0">Restablece tu contraseña</h5>
                                                                <p class="text-muted mt-2">A unos pasos de recuperar tu cuenta.</p>
                                                            </div>
                                                            <div class="alert alert-success text-center my-4 font-size-12" role="alert">
                                                                Ingresa tu correo electrónico y se te enviarán instrucciones!
                                                            </div>
                                                            <div class="mt-4">
                                                                @if (session('status'))
                                                                ...
                                                                <form class="form-horizontal" method="POST"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="email"
                                                                            ...
                                                                            id="useremail" name="email" placeholder="Ingresa tu email a restablecer"
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    <p>Recordastes tu contraseña? <a href="{{ url('login') }}"
                                                                            class="font-weight-medium text-primary"> Ingresa aquí</a> </p>
                                                                </div>
                                                            </div>
...
{{--                                                            </div>--}}
                                                        ...
                                                        <div class="text-center mt-4">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Express El Salvador S.A de C.V   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Apex Code Labs</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

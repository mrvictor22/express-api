            ...
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
                <div class="container">
                    <a class="navbar-brand" href="index">
                        <img src="{{ URL::asset('assets/images/ssss.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="55">
                        <img src="{{ URL::asset('assets/images/ssss.png') }}" class="card-logo card-logo-light" alt="logo light"
                            height="17">
                    </a>
                    ...
                    <div class="row text-center gy-4">
                        <div class="col-lg-3 col-6">
                            <div>
                                ...
                                <div class="text-muted">Envios Completados</div>
                            </div>
                        </div>
                        <!-- end col -->
